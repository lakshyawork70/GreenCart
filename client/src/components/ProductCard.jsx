        ...
        <div className="flex items-end justify-between mt-3">
          ...
          className="text-primary">
            {!cartItems[product._id] ? (
              <button
                className="cursor-pointera flex items-center justify-center gap-1 bg-primary-10 border border-primary-40 md:w-[80px] w-[64px] h-[34px] rounded text-primary-600 font-medium"
